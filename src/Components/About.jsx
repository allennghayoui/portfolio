...
function About() {
    return (
        <div id="about" className="About flex flex-col items-center align-center justify-center text-center pt-10 pb-2">
            <h1 className="Name text-6xl font-black mb-16 lg:text-9xl md:text-8xl sm:text-7xl
                            dark:text-stone-300">Allen Nghayoui</h1>
            <div className="photo-container h-52 w-52 lg:h-72 lg:w-72 md:w-64 md:h-64 sm:h-56 sm:w-56 mb-10">
                <img
